...
if 'Contents' in responses:
    for obj in responses['Contents']:
        ...
        name, email, phone, skills, linkedin = transform_resume.get_structured_data(file_key=file_key, s3=s3)
        load_to_sql_server.connect(name, email, phone, skills, linkedin)
